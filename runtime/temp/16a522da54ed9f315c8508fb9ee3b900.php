<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\AppServ\www\jmyp\public/../application/admin\view\colum\index.html";i:1524553359;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a class="btn btn-primary" href="<?php echo url('add'); ?>"><span class="glyphicon glyphicon-plus"></span>添加分类</a>
	...
	<div class="panel-body userIndexMain">
		<table class='table table-hover table-striped  user'>
			...
			<tr id="tr<?php echo $dat['id']; ?>" class='cls<?php echo $dat['level']; ?>'>
...
// 	id=$(this).attr('id');
// 	$.post("<?php echo url('ajax_s'); ?>",{id:id},function(data){
