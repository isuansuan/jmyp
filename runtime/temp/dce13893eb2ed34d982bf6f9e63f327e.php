<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\AppServ\www\jmyp\public/../application/admin\view\userinfo\index.html";i:1523865409;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a class="btn btn-primary" href="<?php echo url('add'); ?>"><span class="glyphicon glyphicon-plus"></span>添加用户</a>
	...
	<div class="panel-body">
		<table class="table userIndexTable table-bordered">
			...
			<tr id="tr<?php echo $dat['id']; ?>">
				...
				<td><img src="/static/upload/user/<?php echo $dat['img']; ?>" alt="" width="80px" height="50px"></td>
