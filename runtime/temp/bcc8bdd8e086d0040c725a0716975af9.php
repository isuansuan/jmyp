<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\jmyp\public/../application/admin\view\advert\index.html";i:1523276665;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a class="btn btn-primary" href="<?php echo url('add'); ?>"><span class="glyphicon glyphicon-plus"></span>添加广告</a>
	...
	<div class="panel-body">
		<table class="table table-striped userIndexTable">
			...
			<tr id="tr<?php echo $dat['id']; ?>">
				...
				<td><img src="/static/upload/advert/<?php echo $dat['img']; ?>" alt="" height="50px" width="120px"></td>
				<td><?php echo $dat['href']; ?></td>
				
				<td>
					<?php if($dat['type'] == '1'): ?>
					<a href="javascript:;" class="btn btn-danger" onclick="type(this,<?php echo $dat['id']; ?>,<?php echo $dat['type']; ?>)">明日预告</a>
					<?php else: ?>
					<a href="javascript:;" class="btn btn-rimary" onclick="type(this,<?php echo $dat['id']; ?>,<?php echo $dat['type']; ?>)">今日疯抢</a>
...
function type(obj,id,val){
	if(val){
		$.post("<?php echo url('ajax_type'); ?>",{id:id,type:1},function(data){
			if(data){
				$(obj).html('明日预告');
		...
		$.post("<?php echo url('ajax_type'); ?>",{id:id,type:0},function(data){
			if(data){
				$(obj).html('今日疯抢');
