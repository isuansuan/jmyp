<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\AppServ\www\jmyp\public/../application/admin\view\orders\code.html";i:1522762108;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="breadcrumb">
	...
	<li><a href="" class='font'>查看商品</a></li>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table  userIndexTable table-bordered">
			...
			<tr code="tr<?php echo $dat['ordernum']; ?>">
				<td><?php echo $dat['ordernum']; ?></td>
                
				<td><?php echo $dat['sname']; ?></td>
			
				<td><img src="/static/upload/shop/<?php echo $dat['simg']; ?>" alt="" height="50px" width="120px"></td>
				<td><?php echo $dat['price']; ?></td>
				<td><?php echo $dat['num']; ?></td>
				<td><?php echo $dat['price']*$dat['num']; ?>元</td>
