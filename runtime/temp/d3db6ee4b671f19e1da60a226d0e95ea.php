<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"C:\AppServ\www\jmyp\public/../application/admin\view\shop\add.html";i:1523191775;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<script src="/static/admin/baidu/ueditor.config.js"></script>
<script src="/static/admin/baidu/ueditor.all.min.js"></script>
<script src="/static/admin/baidu/lang/zh-cn/zh-cn.js"></script>
<div class="breadcrumb">
	<li><a href="" class='font'>首页</a></li>
	<li><a href="" class='font'>商品管理</a></li>
	<li><a href="" class='font'>添加商品</a></li>
		...
		<form action="" id=""  method="post"  enctype="multipart/form-data" >
			...
			<div class="form-group">
				...
				<select name='brandid' id='' class='form-control'>
					...
					<?php if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bran): $mod = ($i % 2 );++$i;?>

					<option value="<?php echo $bran['id']; ?>"><?php echo $bran['bname']; ?></option>
			...
			<div class="form-group">
				...
				<select name="columid" id="" class="form-control">
					...
					<option value="<?php echo $dat['id']; ?>"><?php echo str_repeat('—', $dat['level']) ?><?php echo $dat['cname']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
