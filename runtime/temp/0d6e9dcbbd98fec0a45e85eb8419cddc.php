<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\jmyp\public/../application/index\view\person\order.html";i:1524576152;s:54:"C:\AppServ\www\jmyp\application\index\view\layout.html";i:1524539667;}*/ ?>
<!doctype html>
<html lang="en">
<head>
...
<!-- 内容 -->	
    <div class="profile">
		...
		<?php if(is_array($fdata) || $fdata instanceof \think\Collection || $fdata instanceof \think\Paginator): $i = 0; $__LIST__ = $fdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fda): $mod = ($i % 2 );++$i;?>
        <div class="tabs-mod__tabs-panels___2HmCD">
        	<dl class="address-memo-mod__an-box___y5ixN"><dt>收货地址：</dt>
        		<dd >姓名：<?php echo $fda['name']; ?></dd>
        		<dd>电话：	<?php echo $fda['tel']; ?></dd>
        		<dd>地址：	<?php echo $fda['addr']; ?>000000</dd>
        	</dl> 	
        </div>
