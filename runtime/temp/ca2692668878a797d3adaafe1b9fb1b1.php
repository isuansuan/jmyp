<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\AppServ\www\jmyp\public/../application/index\view\person\uppass.html";i:1524576161;s:54:"C:\AppServ\www\jmyp\application\index\view\layout.html";i:1524539667;}*/ ?>
<!doctype html>
<html lang="en">
<head>
...
<!-- 内容 -->	
    <div class="profile">
        ...
        <div class="content">
        	<div class="container">
	    		<div class="content">
	    			<form id="settings-form" method="post"  action="" style="margin:auto;margin-top:30px;width:600px;">
        		         <div>
        		         	<div class="input_container shorter">
        		         		<label><span class="spark"> *</span><span data-reactid=".0.0.0.0.0.0.1">选择验证身份方式</span>
        		         		</label>
        		         		<label class="radio" style="width:auto;">
        		         			<input class="radiobox" value="0" type="radio" name="" ><span> 手机验证</span></label><label class="radio"style="width:auto;" ><input class="radiobox" value="1" type="radio" name="" checked="" ><span > 密码验证</span>
        		         		</label>
        		         	</div>
        		         </div>
        		         <div class="input_container shorter">
        		         	<label for="mobile"><span class="spark">* </span><span>手机号</span>
        		         	</label>
        		         	<span class="mobile_masked"><span>180****9073</span><span> </span><a href="/i/account/mobile_bind" target="_blank" class="change_mobile" style="color:#ed145b;">修改</a></span>
        		         </div>
        		         <div class="input_container shorter">
        		         	<label for="password"><span class="spark">* </span><span>新密码</span>
        		         	</label>
        		         	<input type="password" placeholder="" name="password" class="" id="password" ><div class="invalid validWrapper" style="display:block;"><span class="hint valid"><span>6-16 个字符，需使用字母、数字或符号组合，不能使用纯数字、纯字母、纯符号</span></span>
        		         	
        		         	<div class="clear"></div></div>
        		         </div>
        		         <div class="input_container shorter">
        		         	<label for="password"><span class="spark">* </span><span>再次输入密码</span>
        		         	</label>
        		         	<input type="password" placeholder="" name="repassword" class="" id="password" >
        		         	
		    	    		
        		         	<div class="invalid validWrapper" style="display:block;"><span class="hint valid"><span>请再次输入密码</span></span><div class="clear"></div></div>
        		         </div>
        		         <div class="act" style="margin:30px 0 0 130px;">
        		         	<input type="submit" value="提交" id="settings-submit" class="formbutton" name="" >
        		         </div>
        	        </form>
	    		</div>
	    	</div>
...
<script>
	$('input[name=repassword]').focus(function(){
		...
		$(this).css({'width':'160px','height':'23px','box-shadow':'0 0 4px 1px #A5D4ED','border':'none'});
	});
	...
	$('input[name=repassword]').blur(function(){
		...
		if(password!=repassword){
			...
			$(this).data({'s':0});
			$(this).css({'width':'160px','height':'23px','box-shadow':'0 0 4px 1px rgba(228,36,36,0.6)','border':'none'});
		}else{
			$(this).next().hide();
			$(this).data({'s':1});
			$(this).css({'width':'160px','height':'23px','box-shadow':'0 0 4px 1px #A5D4ED','border':'none'});
