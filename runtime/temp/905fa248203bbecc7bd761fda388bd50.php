<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\AppServ\www\jmyp\public/../application/admin\view\orders\contact.html";i:1522762128;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="breadcrumb">
	...
	<li><a href="" class='font'>查看用户</a></li>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table  userIndexTable table-bordered">
			...
			<?php if(is_array($udata) || $udata instanceof \think\Collection || $udata instanceof \think\Paginator): $i = 0; $__LIST__ = $udata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dat): $mod = ($i % 2 );++$i;?>
			<tr id="tr<?php echo $dat['id']; ?>">
				...
				<td><?php echo $dat['addr']; ?></td>
				<td><?php echo $dat['tel']; ?></td>
				
				
                
			<?php endforeach; endif; else: echo "" ;endif; ?>
            <a href="<?php echo url('index'); ?>" class='update'>返回</a>
