<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\AppServ\www\jmyp\public/../application/admin\view\brand\index.html";i:1523276675;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="breadcrumb">
	...
	<li><a href="" class='font'>品牌管理</a></li>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a class="btn btn-primary" href="<?php echo url('add'); ?>"><span class="glyphicon glyphicon-plus"></span>添加品牌</a>
	...
	<div class="panel-body">
		<table class="table userIndexTable table-bordered">
			...
			<tr id="tr<?php echo $dat['id']; ?>">
				...
				<td><img src="/static/upload/brand/<?php echo $dat['bimg']; ?>" alt="" width="80px" height="50px"></td>
				<td><?php echo $dat['cname']; ?></td>
				<td><?php echo $dat['store']; ?></td>
