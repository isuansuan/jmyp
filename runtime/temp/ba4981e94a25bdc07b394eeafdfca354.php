<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\jmyp\public/../application/admin\view\orders\index.html";i:1523276738;s:54:"C:\AppServ\www\jmyp\application\admin\view\layout.html";i:1524573331;}*/ ?>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<table class="table  userIndexTable table-bordered">
			...
			<tr id="tr<?php echo $dat['id']; ?>" code="tr<?php echo $dat['ordernum']; ?>">

				<td><input type="checkbox" name="id" class="check" value="<?php echo $dat['id']; ?>"><?php echo $dat['id']; ?></td>
				<td><?php echo $dat['ordernum']; ?></td>
				<td><?php echo $dat['username']; ?></td>
				
				<td><a href="<?php echo url('code',array('id'=>$dat['id'],'code'=>$dat['ordernum'])); ?>" class='update'>下单商品</a></td>
				<td><?php echo date("Y-m-d H:i:s",$dat['time']); ?></td>
				<td><?php echo $dat['status']; ?></td>
                 <td><a href="<?php echo url('contact',array('id'=>$dat['id'])); ?>" class='update'>联系方式</a></td>
                 <td><?php echo $dat['affrim']==0?"否":"是"; ?></td>
				<td><a href="<?php echo url('edit',array('id'=>$dat['id'])); ?>" class='update'>修改状态</a></td>
